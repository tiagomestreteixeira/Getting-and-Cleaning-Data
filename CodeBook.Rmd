...
- The number of subjects in the data set is 30, having the corresponding id from 1 to 30.  

- The data set have 180 observations of 81 variables.   

-  The first variable is the id of the subject, the second is the Activity and the remaining  
79 variables (Features) are the measurements done about the mean and the standart deviation  
from the time and frequency domain.

Features List (each have values from -1 to 1):
```{r, echo=FALSE}
